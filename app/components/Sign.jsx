...
class Sign extends React.Component{
    ...
    handleClick(user){
        ...
        if(nickname.length>0 && nickname.length <= 20 && password.length>0){
            ...
            signUp(nickname,password).then((resault)=>{
                console.log("user232323:"+JSON.stringify(resault))
                if(resault.isError){
                    if(resault.isNicErr){
                        // this.setState({
                        //     isNicErr:true,
    ...
    componentDidMount(){
        ...
        console.log("location:"+JSON.stringify(window.location))
         //console.log("pathname:"+JSON.stringify(window.location.pathname))
         //console.log("search:"+JSON.stringify(window.location.search))
         this.handleClick("liuchao");
